...
describe('UIX Library Tests', function() {
    ...
    describe('URLs', () => {
        ...
        describe('URL Truncate', () => {

            it('Scheme + host', () => {
                var r = URL.trunc('https://woords.com');
            ...
            it('Absolute url', () => {
                var r = URL.trunc('https://woords.com/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
                expect(r).to.be.equal('/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
            });

            it('Protocol-relative url', () => {
                var r = URL.trunc('//angel:teran@woords.com:808/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
                expect(r).to.be.equal('/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
            });

            it('Root-relative url', () => {
                var r = URL.trunc('/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
                expect(r).to.be.equal('/this/is/the/path?key1=val1&key2=val2&key3=val3#test');
            });
            ...
            it('Simple path', () => {
                var r = URL.trunc('/this/is/a/path');
                expect(r).to.be.equal('/this/is/a/path');
            });

            it('Path with query string (one parameter)', () => {
                var r = URL.trunc('/this/is/a/path?key1=val1');
                expect(r).to.be.equal('/this/is/a/path?key1=val1');
            });

            it('Path with query string (multiple parameters)', () => {
                var r = URL.trunc('/this/is/a/path?key1=val1&key2=val2&key3=val3');
                expect(r).to.be.equal('/this/is/a/path?key1=val1&key2=val2&key3=val3');
            });

            it('Path with a query string and fragment', () => {
                var r = URL.trunc('/this/is/a/path?key1=val1&key2=val2&key3=val3#test');
                expect(r).to.be.equal('/this/is/a/path?key1=val1&key2=val2&key3=val3#test');
            });

            it('Empty path with a query string with one parameter with multiple values and empty fragment', () => {
                var r = URL.trunc('?key1=val1&key1=val2&key1=val3#');
                expect(r).to.be.equal('?key1=val1&key1=val2&key1=val3#');
            });
