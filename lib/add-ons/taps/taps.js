...
(function() {
    ...
    function touchStart(event) {
        ...
        for (var i = 0; i < event.changedTouches.length; i++) {
            ...
            if (touching === 0) {
                on('touchmove', touchMove, { capture: true, passive: true });
                on(['touchend', 'touchcancel'], touchEnd, { capture: true, passive: true });
            }
    ...
    function touchEnd(event) {
        ...
        if (touching === 0) {
            off('touchmove', touchMove, { capture: true, passive: true });
            off(['touchend', 'touchcancel'], touchEnd, { capture: true, passive: true });
        }
    }
    ...
    function mouseStart(event) {
        ...
        on('mousemove', mouseMove, { capture: true, passive: true });
        on('mouseup', mouseEnd, { capture: true, passive: true });
    }
    ...
    function mouseEnd() {
        trackEnd('mouse');
        // Se elimina el tratamiento de eventos añadidos
        off('mousemove', mouseMove, { capture: true, passive: true });
        off('mouseup', mouseEnd, { capture: true, passive: true });
    }
    ...
    // Initialization --------------------------------------------------------------------------------------------------
    on('touchstart', touchStart, { capture: true, passive: true });
    on('mousedown', mouseStart, { capture: true, passive: true });
})();