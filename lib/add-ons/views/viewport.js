...
function Viewport(container, options) {
    ...
    if (this.topLevel) {
        ...
        window.addEventListener('popstate', function(event) {
            ...
            if (self.backRequest) {
                var stop = (self.backRequest.path) ? self.comparePaths(path, self.backRequest.path) : true;
                ...
                path = self.backRequest.path || path;
...
Viewport.Request.prototype.pushView = function() {
    ...
    if (this.viewport.topLevel && this.options.history !== View.History.NONE
            && !this.viewport.comparePaths(this.path, location.href)) {
