...
function View(settings) {
    ...
    // TO-DO: Estamos seguros de querer guardar los ajustes iniciales especificados en la creación de la vista o lo
    // dejamos en manos de lo que haga cada implementación con ellos?
...
View.render = function(view, template, options, complete) {
     ...
     * @param {string} name Nombre de la vista o plantilla.
