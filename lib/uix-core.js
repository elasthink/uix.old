...
// }}
    ...
    toggleLoader: function(show, options) {
        ...
        if (!loader) {
            loader = context.querySelector('.uix-loader');
        }
        if (loader) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
     * Muestra un cuadro de mensaje en la parte inferior de pantalla.
     * @param {string} message Mensaje a mostrar.
     */
    // TODO: Especificar el tipo de mensaje, cambiar la apariencia y otras opciones como el tiempo !!!!!!!!!!!!!!!!!!!!!
    toast: function(message) {
        ...
        document.body.appendChild(box = uix.create('div', {
