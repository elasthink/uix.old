...
// }}
    ...
    openDialog: function(name, options) {
        ...
        return dialog.include(wrapper, options, function(err, view) {
            ...
            if (!uix.hasState(wrapper, 'statechange')) {
                window.addEventListener('statechange', uix.putState(wrapper, 'statechange', function() {
                    var curr = uix.getState(wrapper, 'current');
    ...
    closeDialog: function(view, callback) {
        ...
        if (view === uix.getState(wrapper, 'current')) {
            ...
            if (uix.hasState(wrapper, 'statechange')) {
                window.removeEventListener('statechange', uix.clearState(wrapper, 'statechange'));
            }
            if (overlay) {
