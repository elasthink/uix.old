...
// log((show ? 'Removing' : 'Adding') + ' "ui-hide"...');
    ...
    /**
     * Evalua si el elemento especificado está visible o no según la lógica de la función @see uix.toggle.
     * @param {Element} el Elemento especificado.
     * @return {boolean} Devuelve verdadero si está visible o falso en caso contrario.
     */
    isVisible: function(el) {
        return !(uix.hasClass(el, 'ui-hide') && !el.dataset.toggling || el.dataset.toggling === 'hide');
    },
