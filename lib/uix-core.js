...
var uix = {
     ...
     * @param {function} [options.displayToNone] Indica si poner el 'display' a 'none' al ocultar el elemento.
     */
    toggle: function(el, show, transition, options) {
        // TODO: Meter transition por opciones dejando solo show y options como parámetros opcionales !!!
...
// log((show ? 'Removing' : 'Adding') + ' "ui-hide"...');
     ...
     * @param {Element} el Elemento especificado.
     * @param {boolean} toggling Indica si considerar la lógica de la función uix.toggle().
