...
var uix = {
     ...
     * @param {function} [options.displayNone] Indica si poner el 'display' a 'none' al ocultar el elemento.
     */
    toggle: function(el, show, options) {
        ...
        if (options.transition && options.transition !== 'none') {
            ...
            uix.addClass(el, el.dataset.transitionClass = 'ui-transition-' + options.transition);
            if (options.reverse) {
