...
// }}
            ...
            window.requestAnimationFrame(function() {
                uix.toggleClass(el, 'uix-hide', !show);
                // TODO: Deberíamos quitar el estilo "transition: none" ???
                // Se notifica el final de la transición
                complete(true);
            });
            // NOTE: La llamada a requestAnimationFrame() resuelve un problema detectado en Chrome 62.0.3202.73, por el
            // que la vista de selección de modo no se mostraba aunque debiera, no sé si motivado por quitar la clase
            // "uix-hide" nada más engachar su elemento raíz al DOM.
            // De todas formas tenemos que tener cuidado con este cambio porque no estamos siguiendo la regla de quitar
            // o poner la clase "uix-hide" de forma síncrona a la llamada a la función toggle() lo cual nos puede dar
            // problemas si en la misma secuencia se intenta comprobar su condición. Hay que darle una vuelta.
        }
        return true;
    },
