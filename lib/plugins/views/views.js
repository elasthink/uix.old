 ...
 * añadir el tratamiento de eventos, ajustes de dimensiones u otros; después de cargar los datos necesarios, generar la
 * representación gráfica y añadir la vista al documento o elemento vinculado a un vista en construcción.
...
View.prototype.toggle = function(show, complete) {
    ...
    uix.toggle(this.root, show, function() {
        ...
        if (!show && uix.hasClass(self.root, '--remove-view')) {
            self.remove();
        }
    });
};
